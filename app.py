...
def process_analysis(img, sensitivity, calib):
    ...
    for cnt in contours:
        ...
        if w_rect > 1.5 and h_rect > 1.5: 
            ...
            # --- CRITICAL FIX: ACCURATE LENGTH ---
            # arcLength crack ki poori line ko trace karta hai. 
            # Ise 2 se divide kiya hai kyunki contour perimeter naapta hai (aane-jaane dono ka).
            # Isse tedhe-medhe cracks ki bhi sahi length milegi.
